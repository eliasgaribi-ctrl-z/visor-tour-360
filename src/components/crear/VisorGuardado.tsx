...
export function VisorGuardado({ tourId, ir, alFallar }: VisorGuardadoProps) {
  ...
  /* La portada, la marca y el visor perezoso viven en `ConPortada`, que también
     usa la casa publicada: es la misma costura para el dueño y para el
     comprador. Ver su encabezado. */
  return (
    <ConPortada
      tour={tour}
      accion={editar}
